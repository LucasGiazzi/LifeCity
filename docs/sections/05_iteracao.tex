...
\begin{longtable}{|p{2cm}|p{9cm}|p{2.5cm}|}
  ...
  \hline
  EQ05 & Como usuário, quero conversar com minha equipe por um chat integrado na tela da equipe, sem precisar sair para uma tela separada, para manter a comunicação fluida durante as missões. & Completo \\
  \hline
\end{longtable}

\subsubsection{Experiência no mapa}
...
\begin{longtable}{|p{2cm}|p{9cm}|p{2.5cm}|}
  ...
  \hline
  \endhead
  MAP01 & Como usuário, quero que o mapa exiba todas as reclamações próximas à minha localização e filtre automaticamente as distantes, mostrando apenas as mais relevantes, para não me sentir sobrecarregado por excesso de pins. & Completo \\
  \hline
  MAP02 & Como usuário, quero que o filtro de distância se atualize automaticamente conforme eu me movo pela cidade, para ver sempre as reclamações relevantes ao meu entorno atual. & Completo \\
  \hline
\end{longtable}
